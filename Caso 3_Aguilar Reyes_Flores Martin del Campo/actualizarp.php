...
if (isset($_POST["id"], $_POST["nombre"], $_POST["cantidad"], $_POST["precio"])) {
    $id = $_POST["id"];
    $nombre = $_POST["nombre"];
    $cantidad = $_POST["cantidad"];
    $precio = $_POST["precio"];

    $query = "UPDATE Productos SET Nombre = ?, Cantidad = ?, Precio = ? WHERE Cod_Producto = ?";
    $res = actualizar($creds, $query, [$nombre, $cantidad, $precio, $id]);
