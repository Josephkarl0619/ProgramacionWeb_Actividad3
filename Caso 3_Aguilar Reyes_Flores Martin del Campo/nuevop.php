...
$mensaje = "";
if (isset($_POST["nombre"], $_POST["cantidad"], $_POST["precio"])) {
    $nombre = $_POST["nombre"];
    $cantidad = $_POST["cantidad"];
    $precio = $_POST["precio"];

    $query = "INSERT INTO Productos (Nombre, Cantidad, Precio) VALUES (?, ?, ?)";
    $id = insertar($creds, $query, [$nombre, $cantidad, $precio]);
...
<title>Nuevo Producto — Sistema OpticSight</title>
<style>
:root {
...
<header>
    <h1>Sistema OpticSight — Nuevo Producto</h1>
</header>
